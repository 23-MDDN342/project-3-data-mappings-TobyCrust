...
function Face() {
  ...
  this.scaleColourArray = [color(195, 179, 104), color(105, 183, 212), color(195, 99, 85), color(219, 186, 34), color(53, 62, 60), color(228, 229, 231), color(140, 185, 96), color(108, 93, 78), color(138, 117, 97), color(158, 107, 67)] // array holding all of the face colours 

  this.browColourArray = [color(5, 209, 240), color(239, 219, 63), color(198, 174, 130), color(86, 53, 30)] // eyebrow colours
  ...
  this.draw = function (positions) {
    ...
    vertex(positions.left_eyebrow[0][0], positions.left_eyebrow[0][1])
    vertex(this.leftmostEyebrowL[0], this.leftmostEyebrowL[1] + this.eyebrowSpike / 2) // eyebrow spikes
    ...
    this.toothhide = 250 //makes the teeth hidden when the mouth is closed
    ...
    else { // makes it so theres one eye
